...
from supar import EnhancedDependencyParser
...
def main():
    ...
    parser.set_defaults(Parser=EnhancedDependencyParser)
    ...
    subparser.add_argument('--test', help='path to test file') # Attardi
